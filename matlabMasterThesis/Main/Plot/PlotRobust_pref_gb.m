...
'\hline \hline' char(13)...
'\multicolumn{' num2str(j+2) '}{c}{\textbf{Qualitative Assessment, $\mathbf{n_h=1\%}$}}\\' char(13)...
'\\[-2ex]   Variable    			& Benchmark &\multicolumn{' num2str(j-1) '}{c}{Different $\gb$''','s}\\' char(13)...
'\\[-2ex]' char(13)...
'    			& & 15 & 10 & 6 & 4.5 \\' char(13)...
'\hline' char(13)...
...
'\hline' char(13)...
'Equity premium in $\%$	for $n_h=1\%$					    &' ephstr '\\' char(13)...
...
'\end{tabular}' char(13)...
'\end{center}' char(13)...
'\caption[]{\textbf{Benchmark Comparison for different $\mathbf{\gb}$''' 's with $\mathbf{n_h=1\%}$ and $\mathbf{n_l=0\%}$. }TEXT} \label{ta:benchmarpref_ga}' char(13)...
'\end{table}' char(13)...
'\normalsize'];
