...
dataname='robustinterest'                         % name of the file that is used to store the results
...
Npol        =50;
BCfac       =40;                    % how much importance is put on the boundary conditions (factor that multiplies with the error)
