...
dataname='mutliplechanges'                         % name of the file tha is used to store the results
...
gamma(1)        =3;    %risk aversion of type A
gamma(2)        =6;     %risk aversion of type B
psi             =0.55;      %elasticity of intertemporal substitution (EIS)
...
n2              =1.1;      %nominal rate policy 2 in percent
